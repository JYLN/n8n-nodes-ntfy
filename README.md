...
View this repo's [Usage](https://github.com/JYLN/n8n-nodes-ntfy/wiki/usage) & [Credentials](https://github.com/JYLN/n8n-nodes-ntfy/wiki/credentials) page within the GitHub wiki to learn more about how to use this n8n node.
